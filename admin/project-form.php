...
<body class="min-h-screen text-white flex">
                ...
                <form id="projectForm" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="4"
                            required
                            class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#C6FCA6] transition"></textarea>
                    </div>
                    ...
                    <div id="gradientFields" class="tab-content space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                name="svg_code"
                                rows="6"
                                class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white font-mono text-sm focus:outline-none focus:ring-2 focus:ring-[#C6FCA6] transition"></textarea>
    ...
    <div class="w-full bg-gray-700 rounded-full h-2.5">
      <div class="bg-[#4ade80] h-2.5 rounded-full w-3/4 animate-pulse"></div>
    </div>
  `,
                ...
                if (response.ok) {
                    Swal.fire({
                            ...
                            color: '#ffffff', // White text
                            iconColor: '#4ade80', // Green success icon
                            confirmButtonColor: '#4ade80' // Green confirm button
                        })
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: data.message || 'Error saving project',
                        background: '#1e1e1e', // Dark background
                        color: '#ffffff', // White text
                        iconColor: '#f87171', // Red error icon
                ...
                Swal.fire({
                    ...
                    background: '#1e1e1e', // 🖤 Dark background
                    color: '#ffffff', // 🤍 White text
                    iconColor: '#f87171', // ❌ Bright red error icon
                    confirmButtonColor: '#ef4444' // 🔴 Red confirm button
                });
